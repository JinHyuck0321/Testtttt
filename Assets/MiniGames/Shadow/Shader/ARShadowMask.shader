Shader "FX/TransparentShadowMask"
{
    Properties
    {
    ...
    SubShader
    {
		Tags{"Queue" = "Transparent+100" "RenderType" = "Transparent" "RenderPipeline" = "UniversalRenderPipeline" "IgnoreProjector" = "True"}
        LOD 200
        ...
        Pass
        {
            ...
            Varyings HiddenVertex(Attributes input)
            {
                ...
                output.uv = TRANSFORM_TEX(input.uv, _ShadowMask);
            ...
            half4 HiddenFragment(Varyings input) : SV_Target
            {
                ...
                half4 col = tex2D(_ShadowMask, input.uv);
				
                return half4(_SubtractiveShadowColor.xyz, (1 - s) * _Intensity * col.r);
            }
            ENDHLSL
        }
